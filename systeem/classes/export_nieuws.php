<div class="row nieuws">
    ...
    $sql = "SELECT id, titel, nieuws, author FROM nieuws ORDER BY id DESC LIMIT 3";
...
<br><br><br><center><a href="nieuws"><button class="btn btn-primary">Lees meer burgerveen nieuws <i class="fa fa-angle-double-right" aria-hidden="true"></i></button></a></center>