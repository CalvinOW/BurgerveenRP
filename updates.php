...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="updates" style="font-size: 18px; border-bottom: 1px solid !important;"><span class="fa fa-gear"></span> Updates</a>
                </li>
                <li class="nav-item">
    ...
    <div class="nieuws-intro">
            <h3>BURGERVEEN UPDATES</h3>
            <center>
                <hr class="nieuws">
            </center>
        </div>
        <?php include_once("./systeem/classes/export_updates.php"); ?>
    </div>
</body>
