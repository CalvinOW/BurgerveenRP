...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="nieuws" style="font-size: 18px; border-bottom: 1px solid !important;"><span class="fa fa-newspaper-o"></span> Nieuws</a>
                </li>
                <li class="nav-item">
    ...
    <div class="nieuws-intro">
        ...
        <?php include_once("./systeem/classes/export_nieuws_groot.php"); ?>
    </div>
</body>
